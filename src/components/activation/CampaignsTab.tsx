    ...
    <div>
      ...
      {campaigns.length === 0 ? (
        <div className="p-8 rounded-lg text-center" style={{ background: "var(--bg-surface1)", border: "1px solid var(--border-default)", borderRadius: 8 }}>
          ...
          <p className="text-sm mb-1" style={{ color: "var(--text-muted)", fontFamily: "'DM Sans'" }}>Nenhuma campanha de ads</p>
              ...
              >
                ...
                {isExpanded && (
                  <div className="px-4 pb-4" style={{ borderTop: "1px solid var(--border-default)" }}>
                    ...
                    {/* Adset info */}
                    {campaign.adset_name && (
                      <div className="mb-3 p-2 rounded" style={{ background: "var(--bg-surface2)" }}>
                    ...
                    {campCreatives.length > 0 ? (
                      <div className="space-y-2">
                        <p className="text-[10px] uppercase tracking-wider" style={{ fontFamily: "'JetBrains Mono', monospace", color: "var(--text-muted)" }}>
                        ...
                        {campCreatives.map(creative => (
                          ...
                          >
                            <div>
                              ...
                              {creative.caption && (
                                <p className="text-[10px] truncate max-w-[300px] mt-0.5" style={{ color: "var(--text-muted)", fontFamily: "'DM Sans'" }}>
